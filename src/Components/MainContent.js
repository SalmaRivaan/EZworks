                                                    ...
                                                    <tr key={index}>
                                                        <td colSpan='2' >
                                                            ...
                                                            <div style={{ display: "flex", alignItems: "center" }}>
                                                                ...
                                                                <p>{entity.MSLA}</p>
                                                                <p style={{ marginLeft: "10px"}}><i className="fa fa-eye" aria-hidden="true"></i></p>
                                                                <p Style={{ fontSize: "1rem" }}className="download_icon">
                                                                    <i className="fa fa-download"  faria-hidden="true"></i>
                                                                </p>
                                                            </div>
